...
export default function InteractiveHero({ onOpenBooking }: InteractiveHeroProps) {
  ...
  return (
    <div
      ref={heroRef}
      className="relative w-full h-screen overflow-hidden flex items-center justify-center bg-gradient-to-b from-[#0D1B2A] via-[#0F1E30] to-[#0D1B2A]"
    >
      ...
      <ParticleRain count={25} color="rgba(21, 101, 192, 0.2)" />

      {/* Floating game pieces with hover transitions */}
      <motion.div
        whileHover={{ scale: 1.3, rotate: 15 }}
        className="absolute top-24 left-[8%] text-5xl opacity-80 float-anim text-[#1E88E5] select-none pointer-events-auto cursor-pointer drop-shadow-[0_0_12px_rgba(30,136,229,0.6)]"
      ...
      <motion.div
        whileHover={{ scale: 1.3, rotate: -15 }}
        className="absolute top-36 right-[10%] text-4xl opacity-80 float-anim text-[#FF9800] select-none pointer-events-auto cursor-pointer drop-shadow-[0_0_12px_rgba(255,152,0,0.6)]"
      ...
      <motion.div
        ...
        className="absolute bottom-36 left-[12%] text-4xl opacity-80 float-anim text-[#1565C0] select-none pointer-events-auto cursor-pointer drop-shadow-[0_0_12px_rgba(21,101,192,0.6)]"
      ...
      <motion.div
        whileHover={{ scale: 1.3, rotate: -10 }}
        className="absolute bottom-28 right-[8%] text-5xl opacity-80 float-anim text-[#F57C00] select-none pointer-events-auto cursor-pointer drop-shadow-[0_0_12px_rgba(245,124,0,0.6)]"
      ...
      <motion.div
        ...
        className="absolute top-1/2 left-[5%] text-3xl opacity-80 float-anim text-[#1E88E5] select-none pointer-events-auto cursor-pointer drop-shadow-[0_0_10px_rgba(30,136,229,0.5)]"
      ...
      <motion.div
        ...
        className="absolute top-1/3 right-[6%] text-3xl opacity-80 float-anim text-[#FF9800] select-none pointer-events-auto cursor-pointer drop-shadow-[0_0_10px_rgba(255,152,0,0.5)]"
      ...
      >
        <div className="w-full h-full bg-[#0D1B2A]/80 rounded-xl shadow-2xl border border-[#1565C0]/20 p-3 transform rotate-12 flex flex-col justify-between backdrop-blur-sm">
          <div className="flex justify-between items-center text-[#1E88E5]">
            <span className="font-serif text-sm font-bold">A</span>
            <span>♠</span>
          </div>
          <div className="flex justify-center text-[#FF9800] my-auto scale-125">
            <svg viewBox="0 0 24 24" className="w-8 h-8 fill-current">
              <path d="M12 2C11.5 2 10 5 10 9c0 3 2 5 2 5s2-2 2-5c0-4-1.5-7-2-7zm0 13c-2.2 0-4 1.8-4 4h8c0-2.2-1.8-4-4-4z" />
            </svg>
          </div>
          <div className="flex justify-between items-center text-[#1E88E5] rotate-180">
            <span className="font-serif text-sm font-bold">A</span>
            <span>♠</span>
          </div>
        </div>
      ...
      >
        <svg viewBox="0 0 100 100" className="w-full h-full fill-[#1565C0]/20 stroke-[#1E88E5] stroke-2 opacity-80 drop-shadow-xl">
